    ...
    class DataAccessLayer
    {
        private static string Con()
        {
            ...
            if (Properties.Settings.Default.Mode == true)
                return string.Format("Data Source=localhost\\SQLEXPRESS01; Initial Catalog=Pharmacy;Integrated Security=true", Properties.Settings.Default.Server, Properties.Settings.Default.Database);
            else
                return string.Format("Data Source=localhost\\SQLEXPRESS01; Initial Catalog=Pharmacy;Integrated Security=true", Properties.Settings.Default.Server, Properties.Settings.Default.Database);
